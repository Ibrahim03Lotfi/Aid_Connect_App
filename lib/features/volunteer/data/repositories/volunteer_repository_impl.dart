...
class VolunteerRepositoryImpl implements VolunteerRepository {
  ...
  final List<VolunteerCase> _availableCases = [
    VolunteerCase(
      ...
      description: 'نحتاج متطوعين لتوزيع 50 سلة غذائية على الأسر المحتاجة في منطقة مصر الجديدة. المهمة تشمل تحميل السلال من المستودع وتوزيعها على العناوين المحددة.',
    ...
    VolunteerCase(
      ...
      description: 'نحتاج متطوعين للتسجيل والتنظيم في حملة التبرع بالدم التي ستقام في مستشفى الأقصر العام.',
      category: 'علاج طبي',
      governorate: 'الأقصر',
      priority: 'urgent',
