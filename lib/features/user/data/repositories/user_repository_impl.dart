...
class UserRepositoryImpl implements UserRepository {
  ...
  final List<GovernorateModel> _mockGovernorates = [
    GovernorateModel(id: 1, name: 'دمشق', casesCount: 45),
    GovernorateModel(id: 2, name: 'حلب', casesCount: 38),
    GovernorateModel(id: 3, name: 'حمص', casesCount: 28),
    GovernorateModel(id: 4, name: 'حماة', casesCount: 22),
    GovernorateModel(id: 5, name: 'اللاذقية', casesCount: 19),
    GovernorateModel(id: 6, name: 'طرطوس', casesCount: 15),
    GovernorateModel(id: 7, name: 'درعا', casesCount: 14),
    GovernorateModel(id: 8, name: 'السويداء', casesCount: 11),
    GovernorateModel(id: 9, name: 'دير الزور', casesCount: 18),
    GovernorateModel(id: 10, name: 'الرقة', casesCount: 12),
    GovernorateModel(id: 11, name: 'الحسكة', casesCount: 16),
    GovernorateModel(id: 12, name: 'إدلب', casesCount: 20),
    GovernorateModel(id: 13, name: 'القنيطرة', casesCount: 9),
    GovernorateModel(id: 14, name: 'ريف دمشق', casesCount: 25),
  ];
